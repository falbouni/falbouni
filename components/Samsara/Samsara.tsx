    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.intro}>
          Across multiple productions, we helped shape the visual and narrative
          identity behind Samsara&apos;s launch.
        </p>

        <p className={styles.intro}>
          The goal was to build anticipation and give the community a story they
          could follow, believe in, and share.
        </p>
        ...
        <div className={styles.featureContent}>
          <div className={styles.featureText}>
            ...
            <p>
              ...
              launch, we created a cinematic VFX video designed to feel like the
              culmination of the entire campaign.
            </p>
            ...
            <p>
              Samsara was no longer just &quot;coming soon.&quot; It was ready to
              enter the market.
            </p>
          </div>
        ...
        <div className={styles.splitGrid}>
          <div className={styles.splitText}>
            ...
            <p>
              ...
              with hundreds of professional applicants reviewed before the final
              talent was selected.
            </p>

            <p>
              The cinematic score was produced with live woodwind instruments
              and vocalists, giving the film a more organic, immersive emotional
              texture.
            </p>
        ...
        <div className={styles.trailerGrid}>
          <div className={styles.trailerCard}>
            ...
            <div className={styles.trailerText}>
              ...
              <p>
                The final trailer brought both founders into one cohesive story,
                capturing the mission behind Samsara and turning the upcoming
                launch into an emotionally driven campaign moment.
              </p>
            </div>
          </div>
          ...
          <div className={styles.trailerCard}>
            ...
            <div className={styles.trailerText}>
              <p>
                Following the positive community response to the first trailer,
                the founders requested a second production session while they
                were together in Abu Dhabi.
              </p>
              ...
              <p>
                The trailer took a more uplifting narrative direction, shifting
                the tone toward hope and the larger mission behind Samsara.
              </p>
            </div>
          </div>
        </div>
